  ...
  try {
    ...
    try{
      accArr = await page.evaluate((account) => {
        ...
        let tempArr = []
        collectData(document,account,tempArr,1)
        collectData(document,account,tempArr,2)
        collectData(document,account,tempArr,3)
        collectData(document,account,tempArr,4)
        collectData(document,account,tempArr,5)
        return tempArr;
      },account);
    } catch (e) {
      console.log("retry .....",e)
