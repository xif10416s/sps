...
docker run -e "MAX_QUEUE_LENGTH=100"  -e "CONNECTION_TIMEOUT=90000000"  -e "MAX_CONCURRENT_SESSIONS=100"  -e "PREBOOT_CHROME=true" -e "KEEP_ALIVE=true"  -p 3002:3000 -m 6g --memory-swap -1 --restart always -d --name browserless3002 browserless/chrome
docker run -e "MAX_QUEUE_LENGTH=100"  -e "CONNECTION_TIMEOUT=90000000"  -e "MAX_CONCURRENT_SESSIONS=100"  -e "PREBOOT_CHROME=true" -e "KEEP_ALIVE=true"  -p 3003:3000 -m 6g --memory-swap -1 --restart always -d --name browserless3003 browserless/chrome
