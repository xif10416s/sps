...
alter table battle_history_raw_v2 add partition (partition p20221205 values less than('2022-12-05'));
 ...
 CREATE oR REPLACE VIEW view_most_win_team as select mana_cap, ruleset , summoner_id,monster_1_id,monster_2_id,monster_3_id,monster_4_id,monster_5_id,monster_6_id ,count(*) as cnt from battle_history_raw_v2 where  player_rating_initial >=800 and player_rating_initial >=2500 and created_date_day>= '2021-12-25' group by mana_cap, ruleset , summoner_id,monster_1_id,monster_2_id,monster_3_id,monster_4_id,monster_5_id,monster_6_id order by mana_cap ,cnt desc  ;