CREATE TABLE `battle_history_raw_morden`  (
  ...
  INDEX `index_rule`(`ruleset`) USING BTREE,
...
备份
insert into  battle_history_raw_morden_new (`battle_queue_id`,
  `summoner_id` ,
  `summoner_level` ,
  `monster_1_id` ,
  `monster_1_level` ,
  ...
  `ruleset` ,
  `inactive` ,
  `player_rating_initial`,
  `player_rating_final`,
  `winner` ,
  `battle_queue_id_lost` ,
  `summoner_id_lost`,
  `summoner_level_lost`,
  `monster_1_id_lost`,
  ...
  `monster_2_id_lost` ,
  `monster_2_level_lost` ,
  `monster_2_abilities_lost` ,
  `monster_3_id_lost` ,
  `monster_3_level_lost` ,
  `monster_3_abilities_lost` ,
  `monster_4_id_lost`,
  `monster_4_level_lost` ,
  `monster_4_abilities_lost` ,
  `monster_5_id_lost`,
  `monster_5_level_lost` ,
  `monster_5_abilities_lost` ,
  `monster_6_id_lost` ,
  `monster_6_level_lost` ,
  `monster_6_abilities_lost` ,
  `player_rating_initial_lost`,
  `player_rating_final_lost` ,
  `loser`)  select
`battle_queue_id`,
  `summoner_id` ,
  `summoner_level` ,
  `monster_1_id`,`monster_1_level` ,
  `monster_1_abilities`,
  `monster_2_id`  ,
  `monster_2_level` ,
  `monster_2_abilities` ,
  ...
  `player_rating_initial_lost`,
  `player_rating_final_lost` ,
  `loser` from  battle_history_raw_morden where created_date_day >=  '2023-06-01'
